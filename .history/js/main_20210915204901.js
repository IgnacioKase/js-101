...
function imprimir_un_numero(numero, canal_de_salida) {
    canal_de_salida(numero);
}

let valor_de_devuelto = imprimir_un_numero(1, alert);
let valor_de_devuelto = imprimir_un_numero(1, console.log);
// let resultado = 1 + 2;
